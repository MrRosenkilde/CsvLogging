...
{
	public readonly struct EMFPackageReadonlyLoggingModel
	{
		...
		public EMFPackageReadonlyLoggingModel( float x,  float y,  float z,  float qx,  float qy,  float qz,  float qw,  byte sourceId)
		{
			this.x = x;
			this.y = y;
			this.z = z;
